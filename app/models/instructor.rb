class Instructor < ActiveRecord::Base
  ...
  rails_admin do
    edit do
      exclude_fields :trainings, :reset_password_sent_at, :remember_created_at, :sign_in_count, :current_sign_in_at, :last_sign_in_at, :current_sign_in_ip, :last_sign_in_ip, :training_students, :contracts, :meetings, :observations
    end
  end
